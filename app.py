...
# Version "blindée" de ta clé pour éviter les erreurs ASN.1
# On la reconstruit de manière ultra-propre
key_lines = [
    "-----BEGIN PRIVATE KEY-----",
...
if not df.empty:
    for index, row in df.iterrows():
        ...
        with c1:
            # On cherche la colonne 'possede' peu importe son nom exact
