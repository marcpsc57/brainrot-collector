...
def connect_to_gsheet():
    ...
    # Connexion directe avec la variable Python ci-dessus
...
if not df.empty:
    ...
    st.info("Le tableau est vide.")new_val)
            st.rerun()
    with c2:
        st.write(f"**{row.get('nom', 'Inconnu')}**")
